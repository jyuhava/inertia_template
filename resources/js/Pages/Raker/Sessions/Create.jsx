            ...
            <div className="space-y-6">
                <Box variant="black" className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-white">Tambah Sesi Raker</h1>
                        <p className="text-sm text-neutral-400 mt-1">Buat sesi Raker baru untuk diisi oleh seluruh user.</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <TextInput
                                    ...
                                    placeholder="Contoh: Raker 2025/2026"
                                    error={errors.name}
                                    required
                                />
                            ...
                            <div className="md:col-span-2">
                                ...
                                <TextArea
                                    ...
                                    placeholder="Deskripsi singkat tentang sesi Raker ini..."
