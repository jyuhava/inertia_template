...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.tahun-ajaran.store'));
    };

    return (
        <AdminLayout title="Tambah Tahun Ajaran">
            ...
            <div className="space-y-6">
                <Box variant="black" className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-widest text-neutral-400 mb-2">Tahun Ajaran</p>
                        <h1 className="text-2xl font-bold text-white">Tambah Tahun Ajaran</h1>
                    </div>
