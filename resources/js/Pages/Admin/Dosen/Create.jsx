        ...
        <AdminLayout title="Tambah Dosen">
            ...
            <div className="space-y-6">
                <Box variant="black" className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-widest text-neutral-400 mb-2">Dosen</p>
                        <h1 className="text-2xl font-bold text-white">Tambah Dosen Baru</h1>
                    </div>
