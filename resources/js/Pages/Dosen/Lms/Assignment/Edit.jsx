...
export default function Edit({ assignment, chapter, course }) {
    const { data, setData, post, processing, errors } = useForm({
        _method: 'PUT',
        title: assignment.title,
        description: assignment.description || '',
        komponen: assignment.komponen || 'harian',
        bobot_komponen: assignment.bobot_komponen ?? '1',
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('dosen.lms.assignments.update', assignment.id));
    };

    return (
        <AdminLayout title="Edit Tugas LMS">
            ...
            <div className="space-y-6">
                <section className="border border-black bg-black p-6 text-white sm:p-8">
                    ...
                    <h1 className="mt-2 text-2xl font-bold uppercase tracking-tight sm:text-3xl">Edit Tugas</h1>
                ...
                <Box>
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div>
                            <InputLabel htmlFor="file">Ganti Lampiran (Opsional)</InputLabel>
                            <input
                                id="file"
                                type="file"
                            ...
                            {assignment.file_path ? <p className="mt-1 text-xs text-emerald-700">Lampiran saat ini tersedia.</p> : null}
